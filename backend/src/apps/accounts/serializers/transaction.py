...
class BulkTransactionUpdateItemSerializer(TransactionSerializer):
    """Serializer for individual transaction updates in bulk operations. Requires id field."""

    id = serializers.IntegerField(required=True, help_text="Transaction ID to update")
